...
public class EndurancePart extends AbstractPart implements HitPointsModifyingPart {
    ...
    public String toString() {
        ...
        sb.append(String.format("Endurance Part - %s", super.getModel())).append(System.lineSeparator());
        sb.append(String.format("+%d hitPointsModifier", this.getHitPointsModifier())).append(System.lineSeparator());
