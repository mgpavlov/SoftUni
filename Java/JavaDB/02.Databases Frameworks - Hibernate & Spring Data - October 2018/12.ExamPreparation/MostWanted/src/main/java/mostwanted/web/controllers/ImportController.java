...
public class ImportController extends BaseController {
    ...
    public ModelAndView importRaceEntriesConfirm() throws JAXBException, FileNotFoundException, UnsupportedEncodingException {
    ...
    @PostMapping("/races")
    public ModelAndView importRacesConfirm() throws JAXBException, FileNotFoundException, UnsupportedEncodingException {
