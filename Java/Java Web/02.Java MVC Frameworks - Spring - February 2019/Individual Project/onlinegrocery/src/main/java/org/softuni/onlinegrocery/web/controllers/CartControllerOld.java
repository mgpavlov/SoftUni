...
@Controller
@RequestMapping("/cart")
public class CartControllerOld extends BaseController {
    ...
    @Autowired
    public CartControllerOld(ProductService productService, CartService cartService, UserService userService,
