...
import residentevil.domain.entities.enumerations.Magnitude;
import residentevil.domain.entities.enumerations.Mutation;
import residentevil.util.validators.annotations.CreatorValidation;
import residentevil.util.validators.annotations.DateValidation;
...
public class SpreadVirusBindingModel {
    ...
    public SpreadVirusBindingModel() {
    }
