$(() => {
    const app = Sammy('#main', function () {
        ...
        this.post('#/create', function (ctx) {
            ...
            postsService.createTeam(teamName, teamComment)
                .then(function (data) {
                    postsService.joinTeam(data._id)
                        .then((newData) => {
        ...
        this.get('#/catalog/:id', function (ctx) {
            ...
            postsService.loadTeamDetails(teamId)
        ...
        this.get('#/edit/:id', function (ctx) {
            ...
            postsService.loadTeamDetails(ctx.teamId)
                .then((teamInfo) => {
                    ctx.name = teamInfo.name;
                    ctx.comment = teamInfo.comment;
                    this.loadPartials({
        ...
        this.post('#/edit/:id', function (ctx) {
            ...
            postsService.edit(teamId, teamName, teamComment)
                .then(function () {
